...
El método preferido para informar sobre una incidencia en el proyecto es [creando una incidencia en la cuenta de Github del proyecto](https://github.com/ConcelloCoruna/aportaaberta/issues/new).
...
* `PRs-welcome`: las [incidencias marcadas como PRs-welcome](https://github.com/ConcelloCoruna/aportaaberta/labels/PRs-welcome) son funcionalidades bien definidas y que están listas para que quien quiera pueda implementarlas.
